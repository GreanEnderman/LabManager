...
Define the freeze boundary for the TypeScript prototype backend during the migration period so the team can distinguish maintenance-only work from prohibited new heavy production capability expansion.
