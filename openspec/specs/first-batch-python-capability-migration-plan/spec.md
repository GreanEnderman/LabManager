...
Define the first Python migration-wave capability set, contract expectations, dependency-aware sequencing, and per-capability cutover/rollback requirements for heavy backend capabilities moving out of the TypeScript prototype backend.
