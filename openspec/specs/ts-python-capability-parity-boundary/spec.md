...
Define how first-batch Python migration capabilities map to the current TypeScript reference implementation and what parity evidence is required before runtime cutover.
