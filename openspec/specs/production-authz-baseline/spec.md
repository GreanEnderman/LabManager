...
This capability defines the production-grade authentication and authorization baseline for the system, covering role-based access control, token lifecycle management, password security, and failure handling.
