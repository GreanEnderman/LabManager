...
Define the production relational persistence boundary for AI workflow data so schema, repository, and migration work target formal tables instead of snapshot-only storage.
## Requirements
